...
const DataTable = ({ dark, coinData, orderBy }) => {
    ...
    return (
        <div className='px-5' >
           <div className='bg-[#fbf0df] gap-10 flex items-center justify-center w-max px-5 mx-auto mt-5 rounded' a href="https://t.me/jointrustswap" >
                <img className='w-[150px]' src={pomelo} alt="pomelo"/>
                <span className='text-[#021a50] text-[20px]'>Support us on Pomelo!</span>
           </div>
